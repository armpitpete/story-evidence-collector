...
SOURCES_OUTPUT_FILE = "sources_raw_v12.json"
REPORT_OUTPUT_FILE = "source_report_v12.json"

USER_AGENT = "StoryEvidenceCollector/1.2"
...
def main():
    ...
    print("Starting source record extraction")
    ...
    validation_warnings = validate_source_records(source_records)
